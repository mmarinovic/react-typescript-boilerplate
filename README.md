...
Project contains basic folder structure for building react applications. Check this repo for starter with redux[](https://github.com/mmarinovic/react-typescript-starter).
